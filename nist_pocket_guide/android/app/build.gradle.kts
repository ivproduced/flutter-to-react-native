...
android {
    ...
    signingConfigs {
        create ("release") {
            ...
            storePassword = "euC@nn2018!!" // Replace with your keystore password
            keyAlias = "upload" // The alias you used when generating the key
            keyPassword = "euC@nn2018!!"     // Replace with your key password (can be the same as keystore password)
