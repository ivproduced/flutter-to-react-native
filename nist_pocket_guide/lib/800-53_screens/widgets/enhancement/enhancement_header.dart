// --- widgets/enhancement/enhancement_header.dart ---
...
class EnhancementHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    AppDataManager().isFavorite(
      id,
    ); // This call seems to be for its side effect, not its return value
    String displayId = ('${id.toUpperCase().replaceFirst('.', '(')})');
    return Card(
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: const TextStyle(
                      fontSize: 26, // Bigger font size to match control header
